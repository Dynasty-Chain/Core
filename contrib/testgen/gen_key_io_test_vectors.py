...
bech32_templates = [
  ...
  ('dnst',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('dnst',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('dnst',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('dnst',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tdnst',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdnst',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdnst',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdnst',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tdnst',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdnst',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdnst',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdnst',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rdnst',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rdnst',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rdnst',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rdnst', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tdnst',   17, 32, Encoding.BECH32M, False, False, False),
  ('rdnst',  3,  1, Encoding.BECH32M, False, False, False),
  ('dnst',   15, 41, Encoding.BECH32M, False, False, False),
  ('tdnst',    0, 16, Encoding.BECH32,  False, False, False),
  ('rdnst',  0, 32, Encoding.BECH32,  True,  False, False),
  ('dnst',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tdnst',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rdnst',  0, 20, Encoding.BECH32,  False, False, True),
  ('dnst',    0, 20, Encoding.BECH32M, False, False, False),
  ('tdnst',    0, 32, Encoding.BECH32M, False, False, False),
  ('rdnst',  0, 20, Encoding.BECH32M, False, False, False),
  ('dnst',    1, 32, Encoding.BECH32,  False, False, False),
  ('tdnst',    2, 16, Encoding.BECH32,  False, False, False),
  ('rdnst', 16, 20, Encoding.BECH32,  False, False, False),
]
