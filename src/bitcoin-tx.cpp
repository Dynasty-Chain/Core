...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " dynastycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  dynastycoin-tx [options] <hex-tx> [commands]  Update hex-encoded dynastycoin transaction\n" +
            "or:     dynastycoin-tx [options] -create [commands]   Create hex-encoded dynastycoin transaction\n" +
            "\n";
