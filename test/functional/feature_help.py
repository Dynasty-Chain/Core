...
"""Verify that starting dynastycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dynastycoin with -h for help text")
        ...
        self.log.info("Start dynastycoin with -version for version information")
        ...
        self.log.info("Start dynastycoind with -fakearg to make sure it does not start")
