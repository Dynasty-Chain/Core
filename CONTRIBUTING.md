Contributing to DynastyCoin Core
============================

The DynastyCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the DynastyCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/dynastycoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to dynastycoin-qt
...
The following applies to code changes to the DynastyCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall DynastyCoin
Network Protocol consensus changes.

Whether a pull request is merged into DynastyCoin Core rests with the project merge
...
Patches that change DynastyCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DynastyCoin consensus, it must have been
...
The project leader is the release manager for each DynastyCoin Core release.
